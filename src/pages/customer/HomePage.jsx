  ...
  return (
    <div className="home-wrap">
      ...
      <section className="home-hero">
        <h1>당신의 소중한 물건,<br />네모네모가 안전하게 보관합니다</h1>
        <p>강남 1호점 · S/M/L/XL 총 50개 유닛 · 24시간 보안</p>
      ...
      <section className="home-section">
        <div className="section-header">
          ...
          <div className="legend">
            <span className="legend-dot cell-available" />이용 가능 ({stats.available})
            <span className="legend-dot cell-occupied" />사용 중 ({stats.occupied})
            <span className="legend-dot cell-expiring" />만료 임박 ({stats.expiring})
          </div>
        </div>
